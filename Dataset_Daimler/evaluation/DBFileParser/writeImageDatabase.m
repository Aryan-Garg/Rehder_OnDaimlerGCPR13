...
% open file
[fid,msg] = fopen(filename, 'w','native','latin1');
if (fid < 0)
...
for s=1:length(idb.sequences)
    ...
    for i=1:length(imgList)    
        ...
        % ckeller: update image number skipping delete objects
        [ ~, numok ] = idbNumDel(idb,imgList(i));
        idb.images(imgList(i)).numobjects = numok;
